        ...
        <div class="py-8">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 divide-y divide-slate-100">
                    <div v-for="t in transactions" :key="t.id" class="flex items-center justify-between px-4 py-3">
                        <div class="flex items-center gap-3">
                    ...
                    <p v-if="transactions.length === 0" class="px-4 py-6 text-center text-sm text-slate-400">
